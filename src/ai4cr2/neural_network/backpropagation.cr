...
module Ai4cr2
  ...
  module NeuralNetwork
    ...
    #   # and 2 outputs
    #   net = Ai4cr2::NeuralNetwork::Backpropagation.new([4, 3, 2])
    #
    #   # Train the network
    #   1000.times do |i|
    ...
    struct Backpropagation
      ...
      # include Ai4cr2::BreedParent(self.class)
      ...
      def initial_weight_function
        # ->(_n : Int32, _i : Int32, _j : Int32) { Ai4cr2::Utils::Rand.rand_neg_one_to_pos_one_no_zero }
        ->(_n : Int32, _i : Int32, _j : Int32) { Random.rand }
      end
